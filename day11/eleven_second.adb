...
procedure Eleven_Second is
    ...
    iter_flashes : Natural := 0;
    step_id : Natural := 0;
begin

    Text_IO.Put_Line("Advent of Code 2021: 11.1");
    ...
    while iter_flashes /= Raster_Rows * Raster_Columns loop
        step_id := step_id + 1;
        iter_flashes := Do_Step(octopodes);
    end loop;

    Text_IO.Put_Line("Iteration " & Natural'Image(step_id) & " had " & Natural'Image(iter_flashes));

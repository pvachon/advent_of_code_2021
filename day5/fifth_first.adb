...
begin
    ...
    Text_IO.Put_Line("Advent of Code 2021: 5.0");
    ...
    for I in Coordinate_Element'Range loop
        ...
        for line of all_lines loop
            if not (line.start.y = line.finish.y or line.start.x = line.finish.x) then
                goto Skip_Line;
            end if;
            if line.start.y <= I and line.finish.y >= I then
                -- Fill in the X elements
                declare

...
procedure Seven_Second is
    ...
    function Trial(target_loc : in Natural) return Natural is
        ...
        function Sum_of_Count(n : in Natural) return Natural is begin
            return (n * (n + 1))/2;
        end Sum_of_Count;
    begin
        for crab of all_crabs loop
            dist := abs(crab - target_loc);
            fuel := fuel + Sum_of_Count(dist);
        end loop;
...
begin
    ...
    Text_IO.Put_Line("Advent of Code 2021: 7.1");

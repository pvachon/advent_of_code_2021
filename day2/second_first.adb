...
procedure Second_First is
    ...
    begin
        ...
        case cmd is
            ...
            when Forward => horiz := horiz + value;
        end case;
    end Handle_Command;
begin

    Text_IO.Put_Line("Advent of Code 2021: 2.0");
    ...
    while not Text_IO.End_Of_File(file) loop
        ...
        Text_IO.Put_Line("Depth: " & Integer'Image(depth) & " Horizontal: " & Integer'Image(horiz));
    end loop;

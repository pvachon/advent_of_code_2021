...
procedure Six_Second is
    ...
    type Fish_Count is range 0..2**64;

    type States is array(Life_Cycle) of Fish_Count;
    ...
    begin
        for I in States'Range loop
            Text_IO.Put(Life_Cycle'Image(I) & ": " & Fish_Count'Image(fish_states(I)) & ", ");
            sum := sum + fish_states(I);
        end loop;
        Text_IO.Put_Line(" --> SUM: " & Fish_Count'Image(sum));
    end Dump_States;
begin

    Text_IO.Put_Line("Advent of Code 2021: 6.1");
    ...
    for I in 1..256 loop
        ...
        begin
            ...
            Text_IO.Put("Day: " & Natural'Image(I) & ": ");
            Dump_States;
        end;
    end loop;
